...
<body>
	<div class='container'>
		...
		<!-- Add a button -->
		<a href="add" class="btn btn-primary btn-sm mb-3"> Register </a> <a
			href="" class="btn btn-primary btn-sm mb-3"> List All </a>
		...
		<table class="table table-bordered table-striped">
			...
			<c:forEach items="${students }" var="student">
				<tr>
					...
					<td>
						<!--  Add "update" button/link --> <a href="#"
						class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link-->
						<a href="delete?id=${student.studentId}"
